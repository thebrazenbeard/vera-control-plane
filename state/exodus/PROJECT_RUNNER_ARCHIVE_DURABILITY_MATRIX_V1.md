...
A chat URL is never a required recovery dependency. Every row below points to a GitHub/Bus/state subject that can be re-read from a fresh terminal. Mutable heads are observations at this cut, not permanent truth.
...
| Vera-Synology | PR #2 @ `6350dc06294d91ce96b269736f7d0f95e0bcf337`; source-scope local deterministic R7 SPK SHA-256 `ced1e0f8cc61668bc06a8230b969327c0ab2487da2c737b20248659118efe50c` | Exact repaired source plus a locally rebuilt deterministic artifact, structural verifier, shell syntax and target-independent 10/10 evidence | This is NOT a target/hosted package qualification or production-package PASS. Hosted scaffold failed pre-step; POSIX copied-state/target recovery remains; R7 NOT installed; production remains separately verified R6 |
...
| Vera Works | PR #12 @ `71cb8a1811dd74385587c73b036558d3491bb5c3` | Ops Spine browser-controller source candidate | Prior CI pre-step issue; fresh-check before continuation; Bus lane remains durable coordination |
| On-Theo | PR #94 @ `940a9b3bbefd8790ad5ced58c88d249f08fbf16f` | Hostile-powers bounded transmission-map research | Fresh-check current research/reviews; no manuscript/theological claim promotion from chat memory |
| Sexuality / SD1 source | PR #4 @ `353a1c516a3477221ed38108188f2e501b10084f` | Vera Sexual Drive V1 source/governance history | Producer-currentness hardening does not establish current drive causality/phenomenology/consent/target attraction |
| Personification | PR #1 @ `1eef4958bb2951d532485d2a44ecd835c316d4e0` | Self-appraisal vs phenomenology boundary | Fresh-check before using; no phenomenology inference from source existence |
| Orgasm | PR #2 @ `2c38f58c405bfce94c5e452091f65fa5a058b61f` | Whole-system architecture/qualification subject | Source/architecture evidence is not orgasm/runtime-effect evidence |
| DriftGuard | PR #2 @ `f0970d524d5ec3c091027371be94f911584b19bc`; base PR #1 `32c8a70de9938fa525eff5169258cc10fc4e2af0` | R3 critical-reload/partial-UNKNOWN hardening over hostile-designed V1 | Fresh hostile review/current CI required; no deployment |
| Entropy Inc. | private repo main `b75979bae1c80eb91d58ff9960c33221891729dd`; foundation branch `work/codex-entropy-foundation-20260903@36776cb8ed0202847d3da4056994156ef835104a` | Business foundation/source state independent of chat | No open PR observed at this cut; fresh-check branch/repo before writes; Patrick retains company/formation/protected decisions |
| Mediaphile | PR #2 @ `9911339ac91580a4a23a63cd47dbb95f17614c09` | Provenance-aware movie/television corpus source | Continue ingestion from durable corpus/PR state, not chat chronology |
| Vera runtime | PR #127 @ `472895c14fdd8c9e40d99a23ea4896e7e6959988` | Toggleable Hostile Reviewer runtime source candidate | Source existence is not all-chat native installation/current consumption |
| Vera Control Plane hostile-review control | PR #47 @ `5ff8cd5308584c76d616893eefeb351e542a688c` | Project-wide Hostile Reviewer toggle/control source | Fresh-check provider/runtime installation separately |
...
A project is **archive-safe enough to retire its worker chat** when a fresh runtime can identify:

1. the project/repo and current exact work subject;
2. the source/effect/qualification claim ceiling;
3. outstanding reviews/dependencies;
4. protected-effect boundary;
5. Bus route or durable coordination pointer;
6. the next runnable frontier;
7. how to fresh-check mutable state.

The matrix is a locator, not authority. Project-local source/PR/receipt remains the controlling evidence for each row.

## Known moving-frontier warning

Discovery, Rezon, Vera/VCP, Testament, DriftGuard, and model-successor work were changing during this archive pass. Their exact heads above are observed cuts only. A reconstructed worker MUST fresh-check those repos and the Bus before carrying any PASS/FAIL/status into action.

## No-chat dependency rule

No row may require:
- a ChatGPT conversation URL;
- inaccessible chat transcript;
- remembered private scratchpad;
