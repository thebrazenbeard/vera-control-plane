...
EXPECTED_MANIFEST_SHA = "9c8cbda882f794b4237e7c447427123fcc3deb7513b2c17ec39ceb3bdd34439c"
EXPECTED_NATIVE_SHA = "d08306e64848b55e83d5bd8dd8a258f68465812c8eddbb28670decc006858b53"
...
class RestoreV2InstallTests(unittest.TestCase):
    ...
    def test_native_diff_is_only_k00_and_restore_line(self):
        ...
        candidate = NATIVE.read_text(encoding="utf-8").splitlines()
