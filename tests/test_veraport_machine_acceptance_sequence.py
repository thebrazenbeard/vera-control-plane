...
def test_entry_gate_requires_exact_head_and_independent_pass():
    gate = load()["entry_gate"]
    assert gate["vera_mesh_pr12_exact_head_review"] == "PASS_REQUIRED"
    assert gate["independent_reviewer"] == "BT2_OR_EQUIVALENT_INDEPENDENT_REVIEW_REQUIRED"
